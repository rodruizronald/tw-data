...
class CompaniesRepository(BaseRepository):
    ...
    def create(self, name: str, is_active: bool = True) -> Company:
        ...
        Example:
            ...
            ```
        """
        self._logger.info(f"Creating company with name: {name} (is_active={is_active})")
    ...
    def get_all(self) -> list[Company]:
        ...
        Example:
            ...
            ```
        """
        self._logger.debug("Fetching all companies")
        ...
        self._logger.info(f"Retrieved {len(companies)} companies")
        return companies
